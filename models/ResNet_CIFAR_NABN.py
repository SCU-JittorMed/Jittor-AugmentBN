# models/resnet_cifar_nabn.py
import jittor as jt
from jittor import nn

# from models.normalization import GauBatchNorm
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn3 = GauBatchNorm(planes * 4)
        self.relu = nn.ReLU()
        self.downsample = downsample
        self.stride = stride
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                GauBatchNorm(planes * block.expansion)
            )
...
# 构造不同深度的网络
def ResNet_20_CIFAR_NABN(w, h, c, num_classes=10):
    return ResNet_CIFAR_NABN(BasicBlock, [3, 3, 3], w, h, c, num_classes)

def ResNet_32_CIFAR_NABN(w, h, c, num_classes=10):
    return ResNet_CIFAR_NABN(BasicBlock, [5, 5, 5], w, h, c, num_classes)

def ResNet_44_CIFAR_NABN(w, h, c, num_classes=10):
    return ResNet_CIFAR_NABN(BasicBlock, [7, 7, 7], w, h, c, num_classes)



# model = ResNet_20_CIFAR_NABN(32, 32, 3, num_classes=10)
# print(model)
